"""Fine-tune Gemma 4 E2B with plain TRL + PEFT (no DeepSpeed)."""

import sys, os
sys.path.insert(0, os.path.join(os.path.dirname(__file__), "../.."))

from lib.patches import apply_all, unwrap_custom_linear
...
def main():
    p = argparse.ArgumentParser(description="Fine-tune Gemma 4 E2B with TRL + PEFT")
    add_common_args(p)

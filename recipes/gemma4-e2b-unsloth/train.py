"""Fine-tune Gemma 4 E2B with Unsloth QLoRA."""
...
from lib.tokenizer import setup_tokenizer, GEMMA_CHAT_TEMPLATE
...
def main():
    p = argparse.ArgumentParser(description="Fine-tune Gemma 4 E2B with Unsloth QLoRA")
    add_common_args(p)
